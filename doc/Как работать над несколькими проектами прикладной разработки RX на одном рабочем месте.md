...
* по умолчанию каталог для логов сконфигурирован в домашний каталог проекта. Рекомендуется указать абсолютный путь, чтобы при переключении между проектами логи писались в одно место.
