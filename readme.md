# rx-dds-manage-tools
Набор инструментов для расширенного управления рабочим местом прикладного работчика Directum RX 3.3 - 4.1.
...
## 14.02.2022
1. Компонента Manage Applied Projects вынесена в отдельный проект - https://github.com/DirectumCompany/rx-manage-applied-projects.
В рамках этого репозитория остаются скрипты для RX 4.1 и старше
